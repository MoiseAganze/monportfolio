...
import { FiClock, FiTag, FiArrowUpRight, FiShare2 } from "react-icons/fi";
    ...
    <div className="container mx-auto">
      ...
      <div className="block sm:flex gap-0 sm:gap-10 mt-14">
        <div className="w-full sm:w-1/3 text-left">
          ...
          <div>
            <button className=" cursor-pointer font-general-regular text-2xl font-semibold text-ternary-dark dark:text-ternary-light mb-2 flex gap-3 items-center justify-start btn">
              Partager <FiShare2 />
            </button>
